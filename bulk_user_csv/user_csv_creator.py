...
def main():
    ...
    parser.add_argument("--expiration", type=str, default=None, help="Expiry date for user")
    parser.add_argument("--notes", type=str, default=None, help="Notes for this bulk user creation")
    parser.add_argument("output_file", type=str, help="Name of the output CSV file")

    args = parser.parse_args()

    user_data = bulk_user_creator(args.groups, args.name, args.password, args.tag, args.expiration, args.notes)
